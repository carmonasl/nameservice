...
func init() {
	...
	proto.RegisterType((*MsgSetName)(nil), "carmonasl.nameservice.nameservice.MsgSetName")
	proto.RegisterType((*MsgSetNameResponse)(nil), "carmonasl.nameservice.nameservice.MsgSetNameResponse")
	proto.RegisterType((*MsgDeleteName)(nil), "carmonasl.nameservice.nameservice.MsgDeleteName")
	proto.RegisterType((*MsgDeleteNameResponse)(nil), "carmonasl.nameservice.nameservice.MsgDeleteNameResponse")
}
...
var fileDescriptor_df4dec9b515ec245 = []byte{
	...
	0x0d, 0x9c, 0x03, 0x8c, 0x01, 0x01, 0x00, 0x00, 0xff, 0xff, 0xa5, 0xd4, 0x49, 0x78, 0x19, 0x03,
	0x00, 0x00,
}
...
func (c *msgClient) SetName(ctx context.Context, in *MsgSetName, opts ...grpc.CallOption) (*MsgSetNameResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/carmonasl.nameservice.nameservice.Msg/SetName", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) DeleteName(ctx context.Context, in *MsgDeleteName, opts ...grpc.CallOption) (*MsgDeleteNameResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/carmonasl.nameservice.nameservice.Msg/DeleteName", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_SetName_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/carmonasl.nameservice.nameservice.Msg/SetName",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Msg_DeleteName_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/carmonasl.nameservice.nameservice.Msg/DeleteName",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
